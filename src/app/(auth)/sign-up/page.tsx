...
import { Mail, ArrowRight, ArrowLeft, User, Lock } from 'lucide-react'
...
export default function SignUpPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black font-[family-name:var(--font-inter)] text-white selection:bg-[#5ae14c]/30 flex flex-col justify-between">
      <title>{otpSent ? 'Verify Email — LeadFlow CRM' : 'Sign Up — LeadFlow CRM'}</title>
      <VideoBackground />
          ...
          {otpSent ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h1 className="font-[family-name:var(--font-fustat)] text-2xl font-extrabold tracking-tight text-white">Verify your email</h1>
                <p className="text-xs text-white/50 leading-relaxed">
                  We sent a 6-digit code to <strong className="text-white font-bold">{email}</strong>. Enter it below to activate your account.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="fullName" className="font-[family-name:var(--font-schibsted-grotesk)] text-[10px] font-bold uppercase tracking-wider text-white/60">
                    Full Name
                  </label>
              ...
              <p className="text-center text-xs text-white/50">
                ...
                <Link href="/sign-in" className="font-bold text-[#5ae14c] hover:text-[#3fce32] transition-colors">
                  Sign in here
                </Link>
              </p>
            </div>
