  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-zinc-900/60 dark:bg-zinc-950/30 transition-all hover:shadow-md">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#5ae14c]/15 text-[#0e1311] dark:bg-[#5ae14c]/10 dark:text-[#5ae14c]">
          <Icon className="h-5 w-5 text-[#3fce32] dark:text-[#5ae14c]" />
        </div>
...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-[#5ae14c]/20 dark:bg-[#0c0a12] dark:text-zinc-100">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-200/50 bg-slate-50/80 backdrop-blur-md dark:border-zinc-800/40 dark:bg-[#0c0a12]/80">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-3">
            <Link href="/">
              <Logo iconSize={30} textSize="text-lg" theme="green" />
            </Link>
            <span className="rounded-full bg-[#5ae14c]/10 px-2 py-0.5 text-[10px] font-semibold text-[#5ae14c] border border-[#5ae14c]/20">
              BETA
            </span>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600 dark:text-zinc-400">
            <Link href="/#how-it-works" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">How it Works</Link>
            <Link href="/#ai-playground" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Interactive AI</Link>
            <Link href="/#roi-calculator" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">ROI Calculator</Link>
            <Link href="/#security" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Security</Link>
            <Link href="/#faq" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">FAQ</Link>
          </nav>

          {/* CTAs */}
          <div className="hidden md:flex items-center gap-4">
            <Link href="/sign-in" className="text-sm font-medium text-slate-600 hover:text-[#3fce32] dark:text-zinc-400 dark:hover:text-[#5ae14c] transition-colors">
              Sign in
            </Link>
            <Link href="/sign-up">
              <Button size="lg" className="rounded-full bg-[#0e1311] px-6 text-white hover:bg-black dark:bg-[#5ae14c] dark:text-[#0e1311] dark:hover:bg-[#3fce32]">
                Launch App
              </Button>
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="border-b border-slate-200 bg-slate-50 px-6 py-4 md:hidden dark:border-zinc-800 dark:bg-[#0c0a12]">
            <nav className="flex flex-col gap-4 text-sm font-medium text-slate-600 dark:text-zinc-400">
              <Link href="/#how-it-works" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#3fce32] dark:hover:text-[#5ae14c]">How it Works</Link>
              <Link href="/#ai-playground" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#3fce32] dark:hover:text-[#5ae14c]">Interactive AI</Link>
              <Link href="/#roi-calculator" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#3fce32] dark:hover:text-[#5ae14c]">ROI Calculator</Link>
              <Link href="/#security" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#3fce32] dark:hover:text-[#5ae14c]">Security</Link>
              <Link href="/#faq" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#3fce32] dark:hover:text-[#5ae14c]">FAQ</Link>
              <div className="h-px bg-slate-200 my-2 dark:bg-zinc-800" />
              <Link href="/sign-in" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#3fce32] dark:hover:text-[#5ae14c]">Sign in</Link>
              <Link href="/sign-up" onClick={() => setMobileMenuOpen(false)}>
                <Button className="w-full rounded-full bg-[#0e1311] text-white hover:bg-black dark:bg-[#5ae14c] dark:text-[#0e1311]">
                  Launch App
                </Button>
              </Link>
            </nav>
      ...
      <main className="relative overflow-hidden py-16 lg:py-24">
        ...
        <div className="absolute top-1/4 left-1/2 -z-10 h-72 w-72 -translate-x-1/2 rounded-full bg-[#5ae14c]/10 blur-[100px] dark:bg-[#5ae14c]/5" />
        <div className="absolute top-1/3 right-10 -z-10 h-64 w-64 rounded-full bg-[#5ae14c]/5 blur-[80px] dark:bg-[#5ae14c]/5" />

        <div className="mx-auto max-w-4xl px-6">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 no-underline hover:text-[#3fce32] dark:text-zinc-400 dark:hover:text-[#5ae14c] transition-colors"
          >
            &larr; Back to Home
          </Link>

          <div className="mt-8 mb-12 text-left">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#5ae14c]/10 border border-[#5ae14c]/20 px-4 py-1.5 text-xs font-semibold text-[#3fce32] dark:bg-[#5ae14c]/5 dark:border-[#5ae14c]/20 dark:text-[#5ae14c]">
              <FileText className="h-3.5 w-3.5 text-[#3fce32] dark:text-[#5ae14c] fill-[#3fce32]/10 dark:fill-[#5ae14c]/10" />
              Terms of Service
            </div>
          ...
          <div className="space-y-6 text-left">
              ...
              <ul className="list-none p-0 m-0 space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5">
                    <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#3fce32] dark:bg-[#5ae14c]" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <Section icon={Link2} title="Third-Party Integrations">
              ...
              <div className="rounded-lg bg-[#5ae14c]/5 border border-[#5ae14c]/10 p-3 text-[11px] leading-relaxed dark:bg-[#5ae14c]/5 dark:border-[#5ae14c]/10">
                ...
                <a
                  ...
                  className="text-[#3fce32] hover:text-[#5ae14c] dark:text-[#5ae14c] dark:hover:text-[#3fce32] underline font-semibold"
                >
                  Google API Services User Data Policy
                </a>
                . See our{' '}
                <Link href="/privacy" className="text-[#3fce32] hover:text-[#5ae14c] dark:text-[#5ae14c] dark:hover:text-[#3fce32] underline">
                  Privacy Policy
                </Link>{' '}
                for full details.
              </div>
            ...
            <Section icon={Mail} title="Contact & Legal inquiries">
              <p>
                ...
                <a href="mailto:webvoxelstudio.uk@gmail.com" className="text-[#3fce32] hover:text-[#5ae14c] dark:text-[#5ae14c] dark:hover:text-[#3fce32] underline font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-4 space-y-4">
              <div className="flex items-center gap-2.5">
                <Logo iconSize={24} textSize="text-base" theme="green" />
                <span className="rounded-full bg-[#5ae14c]/10 px-1.5 py-0.5 text-[8px] font-bold text-[#5ae14c] border border-[#5ae14c]/20">
                  BETA
                </span>
              </div>
              ...
              <div className="flex items-center gap-4 text-slate-400 dark:text-zinc-650">
                <Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">
            ...
            <div className="lg:col-span-2 space-y-3.5 text-left">
              ...
              <ul className="space-y-2 text-xs text-slate-500 dark:text-zinc-550">
                <li><Link href="/#how-it-works" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">How it Works</Link></li>
                <li><Link href="/#ai-playground" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Interactive AI</Link></li>
                <li><Link href="/#roi-calculator" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">ROI Calculator</Link></li>
                <li><Link href="/#security" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Security Stack</Link></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2 space-y-3.5 text-left">
              ...
              <ul className="space-y-2 text-xs text-slate-500 dark:text-zinc-550">
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">About Us</Link></li>
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Careers</Link></li>
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Press Kit</Link></li>
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Customers</Link></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2 space-y-3.5 text-left">
              ...
              <ul className="space-y-2 text-xs text-slate-500 dark:text-zinc-550">
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Developer Docs</Link></li>
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">API Reference</Link></li>
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Trigger Status</Link></li>
                <li><Link href="#" className="hover:text-[#3fce32] dark:hover:text-[#5ae14c] transition-colors">Security Trust</Link></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2 space-y-3.5 text-left">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-1.5">
                <input 
                  ...
                  className="w-full rounded-md border border-slate-200 bg-slate-50/50 px-2 py-1.5 text-[11px] focus:outline-none focus:ring-1 focus:ring-[#5ae14c] dark:border-zinc-800 dark:bg-zinc-900/40"
                  required
                />
                <button 
                  type="submit"
                  className="rounded-md bg-[#5ae14c] p-2 text-[#0e1311] hover:bg-[#3fce32] transition-colors cursor-pointer"
                >
